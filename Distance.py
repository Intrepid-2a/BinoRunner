...
def doDistanceTask(ID=None, hemifield=None, location=None):
    ...
    setup = localizeSetup(location=location, glasses='RB', trackEyes=[False,False], filefolder=None, filename=None, task='distance', ID=ID) # data path is for the mapping data, not the eye-tracker data!
